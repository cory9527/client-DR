...
def auto_load_model(args, model, model_without_ddp):
    # output_dir = Path(args.output_dir)
...
def evaluate(model, img, device, classes):
...
def build_transform(args):
    ...
    #             transforms.RandomResizedCrop(input_size, scale=(0.08, 1.0), ratio=(0.75, 1.3333),
    ...
    #             transforms.ToTensor(),
    #             # messidor
    #             transforms.Normalize([0.425753653049469, 0.29737451672554016, 0.21293757855892181],
