...
def main(args, path, classes):
    ...
    transform = utils.build_transform(args);
    img = transform(file).unsqueeze(0)
    ...
    if args.eval:
        ...
        utils.evaluate(model,img,device, classes)
    ...
    # total_time_str = str(datetime.timedelta(seconds=int(toNot using distributed modetal_time)))
...
def debug(args):
    ...
    args.epochs = 20
    args.eval = True
    args.resume = "checkpoint-19.pth";


def resnextmain2(path):
...
if __name__ == '__main__':
    ...
    # debug(args)
    # main(args)
    path = "F:/wei/Retinal_blindness_detection_Pytorch/sampleimages/d659d7fd5ccf.png";
    resnextmain2(path)
